...
function BoardColorSplitButton({
    ...
    return (
        ...
        >
            <Tooltip title={applyTooltip} placement="right" slotProps={colorSplitTooltipSlotProps}>
                <span>
                    <IconButton
                        size="small"
                        disabled={disabled}
                        onClick={() => onApply(lastColor)}
                        sx={{ borderRadius: 1, p: 0, ...iconBtnSx }}
                    >
            ...
            <Tooltip title={pickTooltip} placement="right" slotProps={colorSplitTooltipSlotProps}>
                <span>
                    <ButtonBase
                        disabled={disabled}
                        onClick={(event) => {
                    ...
                    <Paper elevation={4} sx={{ p: 1 }}>
                        {detailOpen ? (
                            <Box sx={{ width: 180 }}>
                                ...
                                />
                                <Button fullWidth size="small" variant="contained" sx={{ mt: 0.75 }} onClick={() => pick(draftColor)}>
                                    확인
                                </Button>
                            </Box>
                        ) : (
                            <>
                                ...
                                <Button
                                    fullWidth
                                    size="small"
                                    sx={{ mt: 0.75, fontSize: "0.7rem", minWidth: 0, whiteSpace: "nowrap" }}
